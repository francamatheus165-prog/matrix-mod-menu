/* 
  * Matrix Mod Menu v2 created by マテウス
  * Website: https://github.com/francamatheus165-prog/matrix-mod-menu
  * Youtube: https://github.com/francamatheus165-prog/matrix-mod-menu
  * Discord: https://github.com/francamatheus165-prog/matrix-mod-menu
...
`;
  ...
  function buildMenuHTML() {
    ...
    return `
<div class="header">
    <div class="title">Matrix Mod Menu <span style="font-size:11px;font-weight:700;color:var(--primary-1)">v2.0.0</span></div>
    <div class="tabs">
...
<div id="__cs_options_panel">
  ...
  `;
    ...
    transition: 0.3s;
  `;
    discordTip.textContent = "Open Matrix Client GitHub";
